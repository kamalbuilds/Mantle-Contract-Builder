...
export default function Navbar({ className }: NavbarProps) {
    ...
    return (
        <nav className={`fixed w-full bg-[#141313] text-white border-b border-[#555555] ${className}`}>
                ...
                <div className="flex flex-row space-x-4 ">
                    ...
                    <div className="flex items-center space-x-4 flex-grow mr-12">
                        <div className="flex items-center space-x-2 mr-1">
                            <Image src="/mantle.png" alt="Mantle Logo" className="w-10 h-10 inline-block mr-2" width={10} height={10}/>
