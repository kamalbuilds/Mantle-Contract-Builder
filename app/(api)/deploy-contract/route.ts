...
async function DeployContractToMantleTestnet(contractABI: any, contractBytecode: string, args: any) {
...
export async function POST(req: NextRequest, res: NextResponse) {
    ...
    try {
        const contractData = await DeployContractToMantleTestnet(contractABITest, contractBytecodeTest, args);
...
function getConnectorClient(config: Config<readonly [{
    blockExplorers: { readonly default: { readonly name: "RSK Explorer"; readonly url: "https://explorer.mantle.xyz/"; }; }; contracts?: import("viem").Prettify<{ [key: string]: import("viem").ChainContract | { [sourceId: number]: import("viem").ChainContract | undefined; } | undefined; } & {
    ...
    }> | undefined; id: 31; name: "Mantle Testnet"; nativeCurrency: { readonly decimals: 18; readonly name: "Mantle Testnet"; readonly symbol: "MNT"; }; rpcUrls: { readonly default: { readonly http: readonly ["https://rpc.mantle.xyz"]; }; }; sourceId?: number | undefined; testnet: true; custom?: Record<string, unknown> | undefined; fees?: import("viem").ChainFees<undefined> | undefined; formatters?: undefined; serializers?: import("viem").ChainSerializers<undefined, import("viem").TransactionSerializable> | undefined; readonly network: "mantletestnet";
